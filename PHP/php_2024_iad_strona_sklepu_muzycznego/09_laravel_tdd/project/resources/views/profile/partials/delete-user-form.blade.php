<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Po usunięciu konta, wszystkie jego zasoby i dane zostaną trwale usunięte. Przed usunięciem konta, proszę pobrać wszystkie dane lub informacje, które chcesz zachować.') }}
        </p>
    </header>
